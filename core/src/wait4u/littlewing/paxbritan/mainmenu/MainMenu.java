package wait4u.littlewing.paxbritan.mainmenu;
...
public class MainMenu extends wait4u.littlewing.paxbritan.DefaultScreen implements InputProcessor {
	Sprite title;
	Sprite credits;
	Sprite settings;
	FactorySelector p1;
	...
	wait4u.littlewing.paxbritan.background.BackgroundFXRenderer backgroundFX = new wait4u.littlewing.paxbritan.background.BackgroundFXRenderer();
	Sprite blackFade;
	...
	@Override
	public void show() {	
		wait4u.littlewing.paxbritan.Resources.getInstance().reInit();

		wait4u.littlewing.paxbritan.GameInstance.getInstance().resetGame();
		
		changeToScreen = -1;
		
		backgroundFX = new wait4u.littlewing.paxbritan.background.BackgroundFXRenderer();
		
		title = wait4u.littlewing.paxbritan.Resources.getInstance().title;
		credits = wait4u.littlewing.paxbritan.Resources.getInstance().credits;
		settings = wait4u.littlewing.paxbritan.Resources.getInstance().settings;
		blackFade = wait4u.littlewing.paxbritan.Resources.getInstance().blackFade;
		
		musicOnOff = wait4u.littlewing.paxbritan.Resources.getInstance().musicOnOff;
		...
		help = wait4u.littlewing.paxbritan.Resources.getInstance().help;
		...
		if(prefs.getBoolean("music") == true) { 
			if(wait4u.littlewing.paxbritan.Resources.getInstance().music == null) wait4u.littlewing.paxbritan.Resources.getInstance().reInit();
			if(!wait4u.littlewing.paxbritan.Resources.getInstance().music.isPlaying()) {
				wait4u.littlewing.paxbritan.Resources.getInstance().music.play();
				wait4u.littlewing.paxbritan.Resources.getInstance().music.setLooping(true);
			}
			musicOnOff.setColor(1,1,1,0.5f);
		} else {
			wait4u.littlewing.paxbritan.Resources.getInstance().music.stop();
	...
	public void render(float delta) {
		...
		if (countdown.finished) {
			...
			if (fade >= 1 && cnt>=2) {
				...
				game.setScreen(new wait4u.littlewing.paxbritan.GameScreen(game, playerList, cpuList));
			} else if(fade >= 1 && cnt<1)   {
				if(changeToScreen==1) {
					game.setScreen(new wait4u.littlewing.paxbritan.settings.Settings(game));
				} else {
					game.setScreen(new wait4u.littlewing.paxbritan.help.Help(game));
				}
			}
		}

...
//		camera.translate(400, 240, 0);
		...
		needle = wait4u.littlewing.paxbritan.Resources.getInstance().needle;
		needle.setOrigin(needle.getHeight() / 2, needle.getWidth() / 2);

		production1 = wait4u.littlewing.paxbritan.Resources.getInstance().production1;
		production1.setOrigin(production1.getHeight() / 2, production1.getWidth() / 2);
		production2 = wait4u.littlewing.paxbritan.Resources.getInstance().production2;
		production2.setOrigin(production2.getHeight() / 2, production2.getWidth() / 2);
		production3 = wait4u.littlewing.paxbritan.Resources.getInstance().production3;
		production3.setOrigin(production3.getHeight() / 2, production3.getWidth() / 2);
		
		production_tile1 = wait4u.littlewing.paxbritan.Resources.getInstance().production_tile1;
		production_tile1.setOrigin(production_tile1.getHeight() / 2, production_tile1.getWidth() / 2);
		production_tile2 = wait4u.littlewing.paxbritan.Resources.getInstance().production_tile2;
		production_tile2.setOrigin(production_tile2.getHeight() / 2, production_tile2.getWidth() / 2);
		production_tile3 = wait4u.littlewing.paxbritan.Resources.getInstance().production_tile3;
		production_tile3.setOrigin(production_tile3.getHeight() / 2, production_tile3.getWidth() / 2);
		production_tile4 = wait4u.littlewing.paxbritan.Resources.getInstance().production_tile4;
		production_tile4.setOrigin(production_tile4.getHeight() / 2, production_tile4.getWidth() / 2);

		upgrade_outline = wait4u.littlewing.paxbritan.Resources.getInstance().upgradeOutline;
		upgrade_outline.setOrigin(upgrade_outline.getHeight() / 2, upgrade_outline.getWidth() / 2);
		frigate_outline = wait4u.littlewing.paxbritan.Resources.getInstance().frigateOutline;
		frigate_outline.setOrigin(frigate_outline.getHeight() / 2, frigate_outline.getWidth() / 2);
		bomber_outline = wait4u.littlewing.paxbritan.Resources.getInstance().bomberOutline;
		bomber_outline.setOrigin(bomber_outline.getHeight() / 2, bomber_outline.getWidth() / 2);
		fighter_outline = wait4u.littlewing.paxbritan.Resources.getInstance().fighterOutline;
		fighter_outline.setOrigin(fighter_outline.getHeight() / 2, fighter_outline.getWidth() / 2);

		health_none = wait4u.littlewing.paxbritan.Resources.getInstance().healthNone;
		health_none.setOrigin(health_none.getHeight() / 2, health_none.getWidth() / 2);
		health_some = wait4u.littlewing.paxbritan.Resources.getInstance().healthSome;
		health_some.setOrigin(health_some.getHeight() / 2, health_some.getWidth() / 2);
		health_full = wait4u.littlewing.paxbritan.Resources.getInstance().healthFull;
...
//		}
		...
		if (unitType == 1) {
			...
			wait4u.littlewing.paxbritan.GameInstance.getInstance().fighters.add(new wait4u.littlewing.paxbritan.fighter.Fighter(factory.id, spawn_pos, new Vector2(factory.facing.x, factory.facing.y)));
		} else if (unitType == 2) {
			spawn_pos.sub(10, 10);
			factory.resourceAmount -= bomberCost;
			wait4u.littlewing.paxbritan.GameInstance.getInstance().bombers.add(new wait4u.littlewing.paxbritan.bomber.Bomber(factory.id, spawn_pos, new Vector2(factory.facing.x, factory.facing.y)));
		} else if (unitType == 3) {
			spawn_pos.sub(25, 25);
			factory.resourceAmount -= frigateCost;
			wait4u.littlewing.paxbritan.GameInstance.getInstance().frigates.add(new Frigate(factory.id, spawn_pos, new Vector2(factory.facing.x, factory.facing.y)));
		} else if (unitType == 4) {
...
//		}
		...
		if (factory.button_held) {
			...
			if (health < wait4u.littlewing.paxbritan.Constants.lowHealthThreshold) {
				float factor = health / wait4u.littlewing.paxbritan.Constants.lowHealthThreshold;
				...
				float factor = (health - wait4u.littlewing.paxbritan.Constants.lowHealthThreshold) / (wait4u.littlewing.paxbritan.Constants.highHealthThreshold - wait4u.littlewing.paxbritan.Constants.lowHealthThreshold);
				...
				float factor = (health - wait4u.littlewing.paxbritan.Constants.highHealthThreshold) / (1 - wait4u.littlewing.paxbritan.Constants.highHealthThreshold);

package wait4u.littlewing.paxbritan.help;
...
public class Help extends wait4u.littlewing.paxbritan.DefaultScreen implements InputProcessor {
	...
	public void show() {		
		...
		back = wait4u.littlewing.paxbritan.Resources.getInstance().back;
		...
		fighter = wait4u.littlewing.paxbritan.Resources.getInstance().fighterOutline;
		fighter.setRotation(0);
		bomber = wait4u.littlewing.paxbritan.Resources.getInstance().bomberOutline;
		bomber.setRotation(0);
		frigate = wait4u.littlewing.paxbritan.Resources.getInstance().frigateOutline;
		frigate.setRotation(0);
		upgrade = wait4u.littlewing.paxbritan.Resources.getInstance().upgradeOutline;

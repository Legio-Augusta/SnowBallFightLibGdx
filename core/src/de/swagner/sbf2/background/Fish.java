...
/**
 * Created by nickfarow on 19/10/2016.
 */
...
public class Fish extends Sprite {
    ...
    public Fish(Vector2 position) {
        ...
        switch (MathUtils.random(0, 7)) {
            case 0:
                this.set(de.swagner.sbf.Resources.getInstance().fish1);
                break;
            case 1:
                this.set(de.swagner.sbf.Resources.getInstance().fish2);
                break;
            case 2:
                this.set(de.swagner.sbf.Resources.getInstance().fish3);
                break;
            case 3:
                this.set(de.swagner.sbf.Resources.getInstance().fish4);
                break;
            case 4:
                this.set(de.swagner.sbf.Resources.getInstance().fish5);
                break;
            case 5:
                this.set(de.swagner.sbf.Resources.getInstance().fish6);
                break;
            case 6:
                this.set(de.swagner.sbf.Resources.getInstance().fish7);
                break;
            default:
                this.set(de.swagner.sbf.Resources.getInstance().fish8);
                break;
        }

...
public class MediumEnemyProduction extends FactoryProduction {
    ...
    public void next_action() {
        ...
        for (de.swagner.sbf.Ship fighter : GameInstance.getInstance().fighters) {
        ...
        for (de.swagner.sbf.Ship bomber : GameInstance.getInstance().bombers) {
        ...
        for (de.swagner.sbf.Ship frigate : GameInstance.getInstance().frigates) {

...
import de.swagner.sbf2.sgh_900.SnowBallFight;
import de.swagner.sbf2.sgh_900.microedition.lcdui.Canvas;
...
class GameScreen extends Canvas implements Screen
{
    Game game;
...
//		Resources.getInstance().dispose();
    ...
    // Same as GDX.render, auto call. What about run() ?
    ...
    public void keyPressed(int paramInt)
    {
        ...
        {
            // Key # pressed. What about param.52 ? keycode similar gameAction ?

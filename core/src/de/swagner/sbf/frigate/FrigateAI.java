...
public class FrigateAI {
	...
	public void retarget() {
		target = de.swagner.sbf.Targeting.getNearestOfType(frigate, 0);
		if (target == null) {
			target = de.swagner.sbf.Targeting.getNearestOfType(frigate, 1);
		}
		if (target == null) {
			target = de.swagner.sbf.Targeting.getNearestOfType(frigate, 2);
		}
		if (target == null) {
			target = de.swagner.sbf.Targeting.getNearestOfType(frigate, 3);
		}	
